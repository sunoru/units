...
DERIVED_UNIT = {
    7: (u'Hz', {2: (-1, u's')}),
    8: (u'N', {0: (1, u'm'), 1: (1, u'kg'), 2: (-2, u's')}),
    9: (u'Pa', {0: (-1, u'm'), 1: (1, u'kg'), 2: (-2, u's')}),
    10: (u'J', {0: (2, u'm'), 1: (1, u'kg'), 2: (-2, u's')}),
    11: (u'W', {0: (2, u'm'), 1: (1, u'kg'), 2: (-3, u's')}),
    12: (u'C', {2: (1, u's'), 3: (1, u'A')}),
    13: (u'V', {0: (2, u'm'), 1: (1, u'kg'), 2: (-3, u's'), 3: (-1, u'A')}),
    14: (u'F', {0: (-2, u'm'), 1: (-1, u'kg'), 2: (4, u's'), 3: (2, u'A')}),
    15: (u'\u03a9', {0: (2, u'm'), 1: (1, u'kg'), 2: (-3, u's'), 3: (-2, u'A')}),
    16: (u'S', {0: (-2, u'm'), 1: (-1, u'kg'), 2: (3, u's'), 3: (2, u'A')}),
    17: (u'Wb', {0: (2, u'm'), 1: (1, u'kg'), 2: (-2, u's'), 3: (-1, u'A')}),
    18: (u'T', {1: (1, u'kg'), 2: (-2, u's'), 3: (-1, u'A')}),
    19: (u'H', {0: (2, u'm'), 1: (1, u'kg'), 2: (-2, u's'), 3: (-2, u'A')}),
    20: (u'lm', {6: (1, u'cd')}),
    21: (u'lx', {0: (-2, u'm'), 6: (1, u'cd')}),
    22: (u'Bq', {2: (-1, u's')}),
    23: (u'Gy', {0: (2, u'm'), 2: (-2, u's')}),
    24: (u'Sv', {0: (2, u'm'), 2: (-2, u's')}),
    25: (u'kat', {2: (-1, u's'), 5: (1, u'mol')})
}

DERIVED_DATA = {
    u'atm': (101325.0, {0: (-1, u'm'), 1: (1, u'kg'), 2: (-2, u's')}),
    u'eV': (1.602176565e-19, {0: (2, u'm'), 1: (1, u'kg'), 2: (-2, u's')})
}
